...
function DashboardPage() {
  return (
    ...
    <div className="col-md-6 col-xl-4">
      <div className="card page-card h-100">
        <div className="card-body">
          <h2 className="h5">Custom Orders</h2>
          <p className="text-muted">
          Book made-to-order jewelry, manage specifications, advances, delivery dates, and revisions.
          </p>
          <Link to="/custom-orders" className="btn btn-dark">
          Open custom orders
          </Link>
        </div>
      </div>
